...
def unique_samples_plot(num_unique_samples_dict, plot_md, exp_name):
    ...
    # gccg_num_unique_samples = num_unique_samples_dict["badge"]
    us_num_unique_samples = num_unique_samples_dict["us"]
    glister_num_unique_samples = num_unique_samples_dict["glister"]
    fl1cg_num_unique_samples = num_unique_samples_dict["fl1cg"]
    logdetcg_num_unique_samples = num_unique_samples_dict["logdetcg"]
    random_num_unique_samples = num_unique_samples_dict["random"]
    fl_num_unique_samples = num_unique_samples_dict["fl"]
