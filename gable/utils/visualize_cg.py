...
def unique_samples_plot(num_unique_samples_dict, plot_md, exp_name):
    ...
    plt.figure()
    badge_num_unique_samples = num_unique_samples_dict["badge"][1:]
    # gccg_num_unique_samples = num_unique_samples_dict["badge"][1:]
    us_num_unique_samples = num_unique_samples_dict["us"][1:]
    ...
    random_num_unique_samples = num_unique_samples_dict["random"][1:]
